...
public class GameRoomServiceImpl implements GameRoomService {
    public static GameRoom createGameRoom(SocketIOClient client, GameRoomRequestDto.CreateGameRoomRequestDto dto) {
        GameRoom gameRoom = new GameRoom(new User("pjh", LocalDate.now()));
